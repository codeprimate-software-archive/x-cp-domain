...
/**
 * The WorkPhoneNumber class is...
 * <p/>
 * WorkPhoneNumber.java (c) 20 December 2010
 * @author jblum
 * @version $Revision: 1.1 $
 * @see com.cp.domain.core.beans.AbstractPhoneNumber
 * @see com.cp.domain.core.enums.PhoneNumberType
 */
public class WorkPhoneNumber extends AbstractPhoneNumber {

  public WorkPhoneNumber() {
  }

  public WorkPhoneNumber(final Long id) {
    super(id);
  }

  public WorkPhoneNumber(final String areaCode, final String prefix, final String suffix) {

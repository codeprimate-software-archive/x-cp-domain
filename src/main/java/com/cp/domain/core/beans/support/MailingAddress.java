...
/**
 * The MailingAddress class is...
 * <p/>
 * MailingAddress.java (c) 20 December 2010
 * @author jblum
 ...
 */
public class MailingAddress extends AbstractAddress {

  public MailingAddress() {
  }

  public MailingAddress(final Long id) {
    super(id);
  }

  public MailingAddress(final String street,
                        final String unit,
                        final String city,
                        final State state,

...
/**
 * The CellPhoneNumber class is...
 * <p/>
 * CellPhoneNumber.java (c) 20 December 2010
 * @author jblum
 * @version $Revision: 1.1 $
 * @see com.cp.domain.core.beans.AbstractPhoneNumber
 * @see com.cp.domain.core.enums.PhoneNumberType
 */
public class CellPhoneNumber extends AbstractPhoneNumber {

  public CellPhoneNumber() {
  }

  public CellPhoneNumber(final Long id) {
    super(id);
  }

  public CellPhoneNumber(final String areaCode, final String prefix, final String suffix) {
